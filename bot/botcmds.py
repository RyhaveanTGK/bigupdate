...
────────────────────
{Msg.EMOJI_STAR} Community: @{GROUP} — https://t.me/RyhaveanTeam
{Msg.EMOJI_ROCKET} Updates: @{CHANNEL} — https://t.me/ryhaveanupdates

{Msg.EMOJI_LOCK} <b>Diqqət / Dikkat / Note</b>
╰▸ Bu bot yalnız öz sahibinə xidmət edir. Bot vasitəsilə heç kim öz hesabına
   userbot və ya avto-bot qura bilməz.
╰▸ Bu bot sadece sahibine hizmet eder. Bot üzerinden hiç kimse kendi hesabına
   userbot/oto-bot kuramaz."""


LINK_BUTTONS = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton("📣 Update Kanalı", url="https://t.me/ryhaveanupdates"),
            InlineKeyboardButton("👥 Ryhavean Team", url="https://t.me/RyhaveanTeam"),
        ]
    ]
)


# Bu bot yalnız sahibi üçündür: heç kim bot içindən öz hesabına avto-bot/userbot
# qura bilməz. / This bot serves only its owner; nobody can set up a userbot
# for their own account from inside the bot.
NOT_OWNER_TEXT = (
    "🔒 <b>Yalnız sahib / Sadece sahip / Owner only</b>\n"
    "╰▸ Bu bot yalnız öz sahibinə xidmət edir.\n"
    "╰▸ Bu bot sadece sahibine hizmet eder.\n"
    "╰▸ Buradan hesabınıza userbot/avto-bot qurmaq mümkün deyil.\n"
    "╰▸ Buradan hesabınıza userbot/oto-bot kurulamaz.\n\n"
    "📣 https://t.me/ryhaveanupdates\n"
    "👥 https://t.me/RyhaveanTeam"
)


async def _guard_owner(message: Message) -> bool:
    """True → icazə var. Sahib deyilsə mesaj göndərir və False qaytarır."""
    if _is_owner(message.from_user.id):
        return True
    await message.reply(NOT_OWNER_TEXT, parse_mode=ParseMode.HTML, reply_markup=LINK_BUTTONS)
    return False
...
async def start_handler(client, message: Message):
    try:
        ...
        await message.reply(
            brief_explanation, parse_mode=ParseMode.HTML, reply_markup=LINK_BUTTONS
        )
...
async def ping_command(client, message: Message):
    if not await _guard_owner(message):
        return
